...
var MoviList = function (data, selectorID){
  if( data.length ){
    var Ele = document.createElement('ul');
    var movieName = document.createTextNode('Movie Name');
    var LI = document.createElement('li');
    var thumb = document.createElement('img');
      thumb.setAttribute('src','https://images-na.ssl-images-amazon.com/images/M/MV5BMTU4MDQ4NTM2N15BMl5BanBnXkFtZTgwNDM1NTIzMzI@._V1_UX182_CR0,0,182,268_AL_.jpg');
      thumb.setAttribute('alt','htt');



  }

  var HTMLSelector = document.getElementById( selectorID );

  console.log( HTMLSelector );

  HTMLSelector.appendChild( Ele);
